...
export default function FoodRecipe({ foodid }) {
  ...
  return (
    <>
      <Link to={"/"} className='backbtn'><FaArrowLeft /> Back To Home</Link>
            ...
            <>
              <div>
                ...
                <div className='points'>
                  <span><b>Price $</b> {(food.pricePerServing / 100).toFixed(2)} per serving</span>
                  <span>
                    <strong>⏰ {food.readyInMinutes} Minutes</strong>
                  </span>
                  <span><strong>👨‍👩‍👧 {food.servings} Servings</strong></span>
